            ...
            <List sx={{ p: 0 }}>
                {rooms.map((room) => (
                    <ListItem key={room} disablePadding secondaryAction={
                        isMobile ? (
                            <Box>
                                <IconButton size="small" edge="end" onClick={handleMenuOpen}><MoreVertIcon fontSize="small" /></IconButton>
                        ...
                        <ListItemButton sx={{ borderRadius: 1 }}><ListItemText primary={room} /></ListItemButton>
                    </ListItem>
                ))}
            </List>
        </Box>
